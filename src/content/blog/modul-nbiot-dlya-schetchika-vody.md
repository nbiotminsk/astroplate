...
| Параметр | TELEOFIS RTU102 | Nero 2576 («Квартира и Дом») | Вега NB-11 |
| :------- | :-------------: | :--------------------------: | :--------: |
| **Импульсных входов** | 4 | 2 | 2 |
| **SIM-слотов** | **2** (резервирование) | 1 (МТС на 5 лет в комплекте) | 1 |
| **Антенна** | Выносная магнитная (в компл.) | Встроенная | Встроенная |
| **Автономность** | **до 10 лет** | 5–6 лет | до 7 лет |
| **Защита корпуса** | IP65 (IP68 опция) | IP65 | IP67 |
| **Сертификат СИ РБ** | № 87749-22 | Да | Да |
| **Сервис в комплекте** | ПО «Мой Клиент» + SIM 1 год | UNICBOARD 5 лет + бот + SIM | Приобретаются отдельно |
| **Цена** | **560.00 BYN** *(комплект)* | **552.60 BYN** *(комплект)* | **492.00 BYN** |
...
Часто закладывается в проектную документацию новых жилых домов. Если ваш дом уже спроектирован под Zeta, рекомендуем придерживаться проекта. Для модернизации существующих узлов учета лучше рассмотреть RTU102, а при разряде батареи — заказать [сервисное обслуживание Zeta за 298 BYN](/store/usluga-remont-obsluzhivanie-modulya-zeta-tahat/).
...
> [!IMPORTANT]
> Если у вас нет навыков работы с радиооборудованием, закажите [установку и настройку модуля NB-IoT «под ключ»](/store/ustanovka-i-nastrojka-nb-iot-modulya/). Мастер приедет, подключит, настроит и выдаст акт ввода СДСП — от **280.00 BYN**.
...
| Режим работы | Автономный | Передача 1 раз в сутки для экономии батареи |
...
| :----------- | :----- | :--: |
| **Комплект «Квартира и Дом»** | Модуль Nero 2576 + SIM на 5 лет + UNICBOARD + Telegram-бот | **552.60 BYN** |
| **Комплект «Бизнес и Жилфонд»** | Модуль RTU102 (4 входа) + 2 SIM + ПО «Мой Клиент: Ресурсы» на 1 год | **560.00 BYN** |
| **Радиомодем Вега NB-11** | Компактный модуль Вега NB-11 (2 входа, IP67) | **492.00 BYN** |
| **Счетчик воды Декаст ВСКМ-15 ДГ** | Водомер Ду 15 с импульсным выходом (Беларусь) | **70.00 BYN** |
| **Установка «под ключ»** | Выезд мастера, монтаж, настройка, акты ввода СДСП | **от 280.00 BYN** |
