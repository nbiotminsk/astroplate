...
| **Розничная цена (ориентир)**    | **{{price:vega-nb11}} BYN**                      | ~245–270 BYN                    | **~{{price:rtu102-nb-iot}} BYN** (супер-выгода)      |
...
- **Высокая стоимость:** Розничная цена составляет **{{price:vega-nb11}} BYN**, что делает его самым дорогим решением в тройке (однако цена компенсируется большим количеством каналов).
...
graph TD
    ...
    RTU --> Price["Лучшая цена в Минске (~{{price:rtu102-nb-iot}} BYN)"]
```
...
- **Идеальная цена:** При стоимости около **{{price:rtu102-nb-iot}} BYN** и наличии **4 универсальных импульсных входов** этот модем является безусловным лидером по экономичности.
