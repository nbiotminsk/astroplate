---
title: Teleofis24.by
meta_title: Установка счетчиков воды с дистанционным снятием показаний в Минске
description: Установка и обслуживание счетчиков воды с дистанционным снятием показаний в Минске «под ключ». Выполнение предписаний Водоканала, продажа NB-IoT модулей и готовых комплектов. Безналичный расчет для юрлиц.
...
hero:
  badge: Официальное решение УП "Минскводоканал"
  title: Дистанционный съем показаний воды в Минске "под ключ"
  subtitle: Модуль передачи данных NBIoT + сим-карта + лицензионное ПО в одном
    заказе. Решения для исполнения предписания УП "Минскводоканал" всегда в
    наличии и на складе.
  primaryCta:
    label: Перейти в магазин
    link: /store
...
howToBuy:
  ...
  steps:
    ...
    - title: Оплатите E-POS или запросите счёт по безналу
      description: Для физлиц доступна быстрая онлайн-оплата, для организаций
        подготовим документы.
    - title: Получите доставку / монтаж
      description:
        Организуем доставку по Беларуси и при необходимости выполним монтаж
        и запуск.
    - title: Поддержка после покупки
      description: "Сопровождаем после внедрения: консультации, настройка и
        техническая поддержка."
  helpCard:
    title: Скиньте фото счётчика
    text:
      Отправьте фото вашего счётчика или узла учёта в Telegram и мы подготовим
      точное предложение под ваш объект.
    button:
...
business:
  ...
  text: Счета, договоры, безналичный расчёт, поставки, сервисное обслуживание,
...
faq:
  ...
  items:
    - question: Какие счётчики и датчики вы поддерживаете?
      answer: Поддерживаем популярные модели водо- и теплосчётчиков, а также
        промышленные датчики. Подберём совместимое решение под ваш объект.
    - question: Можно ли оплатить как юрлицо по безналу?
      answer: "Да. Работаем с организациями: выставляем счёт, готовим договор и
        закрывающие документы."
    - question: Вы выполняете монтаж и настройку?
      answer:
        Да, выполняем монтаж, пусконаладку и удалённую настройку с последующей
        технической поддержкой.
    - question: Сколько занимает подбор решения?
      answer:
        Обычно предварительный подбор занимает до 15 минут. Для точного КП можно
        отправить фото счётчика или узла учёта.
    - question: Какие операторы связи работают с NBIoT ?
      answer:
        "На данный момент это два лидера рынка: А1 и МТС. Стоит учитывать что
        наш модуль может работать сразу с двумя сим-картами одновременно !"
---
