---
title: Установка систем дистанционного съема показаний счетчиков воды под ключ
description: Профессиональная установка систем дистанционного съема показаний счетчиков воды в Минске. Выполнение предписаний Минскводоканала, подключение к АСКУЭ, выгодные цены на NB-IoT модули под ключ.
meta_title: Установка счетчиков воды с дистанционным съемом в Минске «под ключ»
date: 2026-05-21
draft: false
faq:
...
**Профессиональная установка систем дистанционного съема показаний (СДСП)** счетчиков воды и тепла в Минске и Минском районе. Поможем быстро выполнить предписание УП «Минскводоканал», подготовить пакет документов для инспектора и успешно сдать узел коммерческого учета в эксплуатацию.
...
| :------------------------------------------------------------------------- | :------------------------------------------------------------------------------------------------------------------------------- | :----------- |
| **NB-IoT модуль Teleofis RTU102** _(только оборудование)_                  | Модем с выносной магнитной антенной, встроенная батарея 3.6 В (до 10 лет работы), SIM-карта МТС со специальным тарифом.          | **260 руб.** |
| **Установка системы «Под Ключ»** _(для существующих импульсных счетчиков)_ | Доставка оборудования, монтаж, пусконаладка, программирование, выдача пакета документов (акт ввода СДСП, акт выполненных работ). | **626 руб.** |
| **Комплект с заменой водомеров** _(модуль + 2 счетчика воды 15 мм)_        | NB-IoT модуль Teleofis, 2 счетчика воды Ду-15 мм с импульсным выходом, монтаж, пломбировка соединений, подготовка актов.         | **756 руб.** |
| **Ремонт и обслуживание Zeta Тахат**                                       | Замена элемента питания Li-SOCl2 3.6 В, восстановление прошивки, перенастройка IP-адресов серверов диспетчеризации.              | **120 руб.** |
