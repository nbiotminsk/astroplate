...
| :-------------------------------- | :-------------------------------------------------------------------------------------------------------------------------------------------------------- | :---------------- |
| **NB-IoT модуль Teleofis RTU102** | Промышленный радиомодем, выносная магнитная антенна, встроенная батарея до 10 лет работы, SIM-карта МТС с тарифом для IoT. Самый дешевый в Минске модуль. | **{{price:rtu102-nb-iot}} руб.**      |
...
| **Установка системы «Под Ключ»**  | Доставка, монтаж контроллера, подключение импульсных кабелей, пусконаладка, запуск передачи данных, пакет актов ввода СДСП.                               | **{{price:modul-sim-programm}} руб.**      |
